          ...
          <div className={styles.contractHeaderActions}>
            {contractFilePath ? (
              <SecureDocumentViewer
                label="Ver contrato"
                title="Contrato"
                buttonClassName={`${styles.headerContractButton} ${styles.headerContractButtonCompact}`}
                documentType="pdf"
              ...
              <Popover open={contractPopoverOpen} onOpenChange={setContractPopoverOpen}>
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className={`${styles.headerContractButton} ${styles.headerContractButtonCompact}`}
                  >
                    Ver contrato
                  </button>
                </PopoverTrigger>
            ...
            <Popover open={contractAssistantOpen} onOpenChange={setContractAssistantOpen}>
              <PopoverTrigger asChild>
                <button
                  type="button"
                  className={`${styles.headerContractButton} ${styles.headerContractButtonWide}`}
                >
                  Consultar dudas sobre el contrato
                </button>
              </PopoverTrigger>
